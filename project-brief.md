# Flood Exposure Mapping for Eti-Osa LGA, Lagos
...
- Eti-Osa administrative boundary - [GRID3 NGA - Operational LGA Boundaries](https://data.grid3.org/datasets)
- Eti-Osa ward administrative boundary - [GRID3 NGA - Operational Wards Boundaries](https://data.grid3.org/datasets)
- Population density (100m) - [WorldPop](https://www.worldpop.org)
- Settlement extents v4.1 - [GRID3](https://data.grid3.org/datasets)
- SRTM DEM (30m) - [USGS EarthExplorer](https://earthexplorer.usgs.gov)
...
- Health facilities - [OpenStreetMap](https://www.openstreetmap.org)
